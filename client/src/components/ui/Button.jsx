...
const Button = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-semibold rounded-xl transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed active:scale-[0.98]';
  ...
  const variants = {
    ...
    white: 'bg-white hover:bg-slate-100 text-slate-900 font-bold shadow-lg shadow-slate-950/20 focus:ring-white',
    outline: 'border-2 border-slate-200 hover:border-slate-300 bg-white text-slate-700 hover:bg-slate-50 focus:ring-slate-400',
    darkOutline: 'border-2 border-slate-700 hover:border-slate-500 bg-slate-800/80 hover:bg-slate-800 text-slate-100 focus:ring-slate-500',
