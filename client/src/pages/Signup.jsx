  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-950 text-slate-900 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-10 w-96 h-96 bg-indigo-600/25 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-10 w-96 h-96 bg-violet-600/20 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-4xl w-full bg-slate-900/90 backdrop-blur-2xl rounded-3xl border border-slate-800 shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 relative z-10">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight leading-tight">
                Join Thousands of Active Students Today
              </h1>
              <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
                Create your account to unlock high-definition video modules and self-paced technical courses.
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2 text-xs text-slate-300">
              <div className="flex items-center gap-2.5">
                ...
                <span>Instant Access to Catalog Courses</span>
              </div>
              <div className="flex items-center gap-2.5">
                <HiCheckCircle className="text-emerald-400 text-base flex-shrink-0" />
                <span>Persisted Learning & Lesson Bookmarking</span>
              </div>
              <div className="flex items-center gap-2.5">
                <HiCheckCircle className="text-emerald-400 text-base flex-shrink-0" />
                <span>No Credit Card Required for Student Account</span>
              </div>
            </div>
          </div>

          <div className="pt-6 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
            <span className="flex items-center gap-1.5"><HiShieldCheck className="text-indigo-400 text-sm" /> Safe & Verified Platform</span>
        ...
        <div className="p-8 sm:p-10 bg-white flex flex-col justify-between space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500">Fill in your details to get started with EduMaster.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <FaUserShield className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-sm" />
                <select
                  {...register('role')}
                  id="role"
